 ...
 * <p>
 * <p>
 * {@code TypeToken<List<String>> list = new TypeToken<List<String>>() {};}</p>
 * <p>
 * <p>This syntax cannot be used to create type literals that have wildcard
 * parameters, such as {@code Class<?>} or {@code List<? extends CharSequence>}.</p>
 *
 * @author Bob Lee
 * @author Sven Mawson
 * @author Jesse Wilson
...
public class TypeToken<T> {
    ...
    @SuppressWarnings("unchecked")
    TypeToken(Type type) {
        this.type = $Types.canonicalize(Latte.checkNotNull(type));
